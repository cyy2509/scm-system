...
<jsp:include page="../common/header.jsp">
    <jsp:param name="title" value="编辑供应商"/>
</jsp:include>
<jsp:include page="../common/menu.jsp"/>

<el-card class="form-card" shadow="never">
    <div slot="header"><h3>编辑供应商</h3></div>

    <c:if test="${not empty errorMsg}">
        <el-alert title="${errorMsg}" type="error" show-icon style="margin-bottom:20px"></el-alert>
    </c:if>

    <form method="post" action="${ctx}/supplier/edit">
        ...
        <el-form label-position="top" size="small">
            ...
            <el-form-item label="备注">
                <el-input name="remark" type="textarea" :rows="3">${supplier.remark}</el-input>
            </el-form-item>
            <el-form-item>
