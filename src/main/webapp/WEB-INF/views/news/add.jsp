...
<jsp:include page="../common/header.jsp">
    <jsp:param name="title" value="发布新闻"/>
</jsp:include>
<jsp:include page="../common/menu.jsp"/>

<el-card class="form-card" shadow="never" style="max-width:700px">
    <div slot="header"><h3><i class="el-icon-edit-outline" style="margin-right:8px"></i>发布新闻</h3></div>

    <c:if test="${not empty errorMsg}">
        <el-alert title="${errorMsg}" type="error" show-icon style="margin-bottom:20px"></el-alert>
    </c:if>

    <form method="post" action="${ctx}/news/add">
        <el-form label-position="top" size="small">
            ...
            <el-form-item>
                <el-button type="primary" native-type="submit" icon="el-icon-check">发布</el-button>
