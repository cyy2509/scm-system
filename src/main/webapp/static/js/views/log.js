...
const LogPage = {
    ...
    <div class="page-card">\
        ...
        <div class="search-bar">\
            <el-input v-model="query.keyword" placeholder="搜索用户名/操作" clearable style="width:200px" @clear="loadData" @keyup.enter="loadData"></el-input>\
            <el-select v-model="query.module" placeholder="选择模块" clearable style="width:140px" @change="loadData">\
                <el-option label="用户" value="User"></el-option>\
                <el-option label="供应商" value="Supplier"></el-option>\
                <el-option label="商品" value="Product"></el-option>\
                <el-option label="采购" value="PurchaseOrder"></el-option>\
                <el-option label="销售" value="SalesOrder"></el-option>\
        ...
        <el-table :data="page.list" v-loading="loading" border stripe>\
            ...
            <el-table-column prop="method" label="方法" width="120"></el-table-column>\
